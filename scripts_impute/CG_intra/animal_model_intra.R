...
variancesCalc(df_transposed_intra, st, end, batch_info, dam_info, tray_info, samplingdate_info, outdir = "/projects/ag-demeaux/labraha3/EpiDom_A_lyrata/Animal_model/intra_impute/intra_CG/output_files/", individual_files = TRUE)