...
#SBATCH --array=1-80              # Define array range (e.g., 1-100 for 100 tasks)
...
total_genes=19799                     # Total number of genes
...
Rscript /projects/ag-demeaux/labraha3/EpiDom_A_lyrata/Animal_model/scripts_impute/CHH_inter/animal_model_CHH.R $start_gene $end_gene