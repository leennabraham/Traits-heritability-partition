...
#SBATCH --array=1-41               # Define array range (e.g., 1-100 for 100 tasks)
...
Rscript /projects/ag-demeaux/labraha3/EpiDom_A_lyrata/Animal_model/scripts_impute/CHG_intra/animal_model_intra.R $start_gene $end_gene