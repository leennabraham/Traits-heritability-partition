...
setwd("/projects/ag-demeaux/labraha3/EpiDom_A_lyrata/Animal_model/intra_impute/intra_CHH/input_files")

# Load the data without setting row names
df_transposed_intra <- read.csv("gBM_CHH_for_animal_model_intra_04_12.csv", header = TRUE, row.names = 1, check.names = FALSE, sep= ",")
...
variancesCalc(df_transposed_intra, st, end, batch_info, dam_info, tray_info, samplingdate_info, outdir = "/projects/ag-demeaux/labraha3/EpiDom_A_lyrata/Animal_model/intra_impute/intra_CHH/output_files", individual_files = TRUE)