...
#SBATCH --array=1-83               # Define array range (e.g., 1-100 for 100 tasks)
...
total_genes=20496                     # Total number of genes
...
Rscript /projects/ag-demeaux/labraha3/EpiDom_A_lyrata/Animal_model/scripts_impute/CHH_intra/animal_model_intra.R $start_gene $end_gene